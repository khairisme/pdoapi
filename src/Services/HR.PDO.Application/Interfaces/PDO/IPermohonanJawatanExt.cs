...
namespace HR.PDO.Application.Interfaces.PDO
{
    public interface IPermohonanJawatanExt
    {
        ...
        public Task<SemakPermohonanJawatanDto> SemakPermohonanJawatan(int Id);
        public Task<MuatPermohonanJawatanOutputDto> MuatPermohonanJawatan(int IdUnitOrganisasi, string? NomborRujukanPrefix);
        public Task HapusTerusPermohonanJawatan(int IdPermohonanJawatan);
        public Task KemaskiniPermohonanJawatan(PermohonanJawatanDaftarDto request);
        public Task KemaskiniSemakPermohonanJawatan(SemakPermohonanJawatanRequestDto request);
        ...
        public Task HantarPermohonanJawatan(HantarRequestDto request);
        public Task KemaskiniUlasanStatusJenisPermohonanJawatan(UlasanStatusJenisRequestDto request);
        public Task<bool?> KemaskiniUlasanStatusKeputusanPermohonanJawatan(UlasanStatusKeputusanRequestDto request);
