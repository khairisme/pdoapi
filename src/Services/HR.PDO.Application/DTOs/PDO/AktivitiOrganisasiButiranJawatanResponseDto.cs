...
{
    /// <summary>
    /// Response DTO for returning detailed information of AktivitiOrganisasi positions.
    /// Contains activity details, hierarchy, and metadata for auditing.
    /// </summary>
    /// <remarks>
    /// Author      : Khairi bin Abu Bakar
    /// Created On  : 2025-08-31
    /// Purpose     : Data Transfer Object (DTO) used to return AktivitiOrganisasi details to the client.
    /// </remarks>
    public class AktivitiOrganisasiButiranJawatanResponseDto
    {
        /// <summary>
