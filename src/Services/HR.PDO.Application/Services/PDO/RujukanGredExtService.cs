...
{
    public class RujukanGredExtService : IRujukanGredExt
    {
        private readonly IPDOUnitOfWork _unitOfWork;
        private readonly PDODbContext _context;
        private readonly ILogger<RujukanGredExtService> _logger;

        public RujukanGredExtService(IPDOUnitOfWork unitOfWork, PDODbContext dbContext, ILogger<RujukanGredExtService> logger)
        {
