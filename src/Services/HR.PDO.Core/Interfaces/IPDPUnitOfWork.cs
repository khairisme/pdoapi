 ...
 * 4. Preserve the dependency on HR.PDO.Core.Entities.BaseEntity
...
/// </summary>
public interface IPDPUnitOfWork : IDisposable 
{

    /// <summary>
    /// Get repository for entity type
    /// </summary>
    IRepository<T> Repository<T>() where T : PDPBaseEntity;
