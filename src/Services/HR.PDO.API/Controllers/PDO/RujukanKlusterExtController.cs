...
namespace HR.PDO.API.Controllers.PDO {
    ...
    public class RujukanKlusterExtController : ControllerBase
    {
        private readonly ILogger<RujukanKlusterExtController> _logger;
        private readonly IRujukanKlusterExt _rujklusterext;

        public RujukanKlusterExtController(IRujukanKlusterExt rujklusterext, ILogger<RujukanKlusterExtController> logger)
        {
