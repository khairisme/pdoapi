...
namespace HR.PDO.API.Controllers.PDO {
    [ApiController]
    [Route("api/pdo/v1/rujukan/status-jawatan")]
    public class RujStatusJawatanExtController : ControllerBase
    {
        private readonly ILogger<RujStatusJawatanExtController> _logger;
        private readonly IRujStatusJawatanExt _rujstatusjawatanext;

        public RujStatusJawatanExtController(IRujStatusJawatanExt rujstatusjawatanext, ILogger<RujStatusJawatanExtController> logger)
        {
