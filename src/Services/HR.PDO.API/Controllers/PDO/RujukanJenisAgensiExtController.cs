...
namespace HR.PDO.API.Controllers.PDO {
    [ApiController]
    [Route("api/pdo/v1/rujukan/jenis-agensi")]
    public class RujukanJenisAgensiExtController : ControllerBase
    {
        private readonly ILogger<RujukanJenisAgensiExtController> _logger;
        private readonly IRujukanJenisAgensiExt _rujjenisagensiext;

        public RujukanJenisAgensiExtController(IRujukanJenisAgensiExt rujjenisagensiext, ILogger<RujukanJenisAgensiExtController> logger)
        {
